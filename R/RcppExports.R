...
#' @export
cvode_Cpp <- function(times, states, parameters, forcings_data, settings, model_) {
    .Call('RcppSundials_cvode_Cpp', PACKAGE = 'RcppSundials', times, states, parameters, forcings_data, settings, model_)
}

#' Simulates the model when it is written as a R function
#' @export
cvode_R <- function(times, states, parameters, forcings_data, settings, model) {
